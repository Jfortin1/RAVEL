...
preprocessWS <- function(input.files, output.files=NULL, brain.mask=NULL, WhiteStripe=FALSE, WhiteStripe_Type="T1", verbose=TRUE, writeToDisk=FALSE, returnMatrix=FALSE){
